...
const sauceSchema = mongoose.Schema({
  ...
  heat: {
    type: Number, required: true, min: [1, 'Must be at least 1! Otherwise, it\'s not spicy...'],
    max: [10, '10 maximum']
  },
  likes: {
    type: Number, default: 0, min: [0, 'Likes number must be 0 on creation'],
    max: [0, 'Tsss, are you trying to cheat by giving you likes ? ']
  },
  dislikes: {
    type: Number, default: 0, min: [0, 'Dislikes number must be 0 on creation'],
